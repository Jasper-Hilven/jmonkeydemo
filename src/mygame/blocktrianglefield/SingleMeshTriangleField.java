...
public class SingleMeshTriangleField implements BlockTriangleField {
  ...
  private HashMap<Vector3, TriangleBlockDescription> positionToBlock;
  ...
  public SingleMeshTriangleField(AssetManager assetManager, PhysicsSpace physics) {
    ...
    positionToBlock = new HashMap<Vector3, TriangleBlockDescription>();
  ...
  public Mesh getMeshFromPositions() {
    ...
    int count = 0;
    for (TriangleBlockDescription triangleBlock : positionToBlock.values()) {
  ...
  private void putSingleBlockMeshInFieldMesh(TriangleBlockDescription triangleBlock, int nthBlock, Vector3f[] vertices, Vector3f[] normals, Vector4f[] colors, int[] indices) {
  ...
  public void setBlock(TriangleBlockDescription block) {
